...
class ImageConverter {
  ...
  static imageLib.Image convertCameraImage(CameraImage cameraImage) {
    if (cameraImage.format.group == ImageFormatGroup.yuv420) {
      ...
      return new imageLib.Image(0, 0);
    }
  }

  /// Converts a [File] to [imageLib.Image]
  static imageLib.Image convertFileToImage(File imageFile) {
    return imageLib.decodeImage(imageFile.readAsBytesSync())!;
  }
  ...
  static imageLib.Image convertBGRA8888ToImage(CameraImage cameraImage) {
    imageLib.Image img =
        imageLib.Image.fromBytes(cameraImage.planes[0].width!, cameraImage.planes[0].height!, cameraImage.planes[0].bytes, format: imageLib.Format.bgra);
    return img;
  }
